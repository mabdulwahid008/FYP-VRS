...
function NewRegisteredCompanies() {
    ...
    return (
        <>
            {companies && <div className='flex flex-col gap-5 items-start justify-start'>
                ...
                <div className='bg-white rounded-xl shadow-md w-full px-4 py-5 header-animate'>
                    ...
                    {companies?.length === 0 && <p className='text-gray-700 mt-3'>No applications found.</p>}
                    {companies?.length !== 0 && <table className='w-full mt-5'>
                        <thead>
